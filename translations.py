TRANSLATIONS = {
    ...
    "el": {
        ...
        "fuzzy_100_hint": "Στο 100%, η Προσεγγιστική Ταύτιση λειτουργεί ουσιαστικά όπως η Ακριβής Ταύτιση, αλλά είναι πιο αργή.",
        "legislative_logic_label": "Λογική συνδυασμού Λέξεων πολιτικής και ρημάτων τροποποίησης ",
        "logic_and": "AND (αυστηρό)",
        "logic_or": "OR (ευρύ)",
        "legislative_logic_help": "Επιλέξτε αν ένα σχόλιο πρέπει να περιέχει και Λέξεις πολιτικής και Ρήματα τροποποίησης (AND) ή έστω ένα από τα δύο (OR).",
